...
public class SwerveDrive {
	 ...
	 * @param pAngularVelocity value between -1 and 1; clockwise is negative, counter-clockwise is positive
	 * @param pRobotVelocity Vector corresponding to robot velocity: x-axis points forward, y-axis points to the right
	 */
